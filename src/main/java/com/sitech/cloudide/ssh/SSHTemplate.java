...
public class SSHTemplate {
    ...
    public Result executeCommand(final Session session, final String cmd, 
    	 ...
    	 * @throws IOException
    	 */
    	public Result scp( String remoteFile, String remoteTargetDirectory, String mode) {
    		try {
					SCPClient client = conn.createSCPClient();
					long len=89;
					client.put( remoteFile,len, remoteTargetDirectory, mode);
					return new Result(true);
				} catch (Exception e) {
					logger.error("scp local="+remoteFile+" to "+remoteTargetDirectory+" remote="+remoteTargetDirectory+" err", e);
					return new Result(e);
				}
    	}
    	...
    	public Result scpToDir(String localFile, String remoteTargetDirectory, String mode) {
    		return scp(localFile , remoteTargetDirectory, mode);
    	}
